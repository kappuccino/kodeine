...
<head>
	...
	.media{
		...
		.media .action{
			...
			#crop{ float: left; margin: 4px 0px 0px 2px; }

			#save-crop{ float: left; margin: 0 5px 0 0; }
			#field-bar{ float: left; }
			#valider{ 	float: left; margin: 0 0 0 5px;  }

			.media .action .l{ float: left; }
			.media .action .r{ float: right; padding-top:2px; }
		...
		.media #photo{
			...
			-moz-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); -webkit-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5);
		}
