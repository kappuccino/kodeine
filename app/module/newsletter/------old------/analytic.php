...
<div>
		...
		<table width="840" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto; margin-top:40px;">
			<tr valign="top">
				...
				<td width="30%" style="padding-top:20px;">
					<div class="clearfix">
						<img src="ui/analytic-vert.gif" alt="analytic-vert" width="10" height="10" style="float:left; margin:3px 10px 0px 0px" />
					...
					<div class="clearfix" style="padding:20px 0px 20px 0px;">
						<img src="ui/analytic-orange.gif" alt="analytic-vert" width="10" height="10" style="float:left; margin:3px 10px 0px 0px" />
						<div style="float:left">
					...
					<div class="clearfix">
						<img src="ui/analytic-blue.gif" alt="analytic-vert" width="10" height="10" style="float:left; margin:3px 10px 0px 0px" />
						<div style="float:left">
	...
	<div style="margin-top:40px; padding:10px 0px 3px 0px; border-top:1px solid #808080;">
		<form method="post" action="analytic">
			...
			Effacer toutes les statistiques et consid&eacute;rer cette newsletter comme non envoy&eacute;<br />
			<input type="submit" class="btn btn-mini" value="Confirmer" />
			Note: cette action n'impacte pas vos quota d'envois
