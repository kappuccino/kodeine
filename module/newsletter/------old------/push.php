...
<table border="0" cellpadding="0" cellspacing="0" width="900" align="center" style="margin-top:40px;">
	...
	<tr>
		<td colspan="3" align="center" height="50">
			<a href="#" onclick="sendToCloud();" id="go" class="button rButton">Transfer cette campagne sur le cloudapp</a>
			<span id="tmp" style="display:none;">Transfer en cours <b style="color:red;">NE FERMER PAS CETTE FENETRE</b></span>
...
<script>
	...
	function sendToCloud(){
		...
		$.ajax({
			'url' : 'ressource/lib/newsletter.push.php',
			'dataType' : 'json',
			'data' : {	'send': true,
						'current': current,
						'chunk': chunk,
